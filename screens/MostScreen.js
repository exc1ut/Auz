...
class HotScreen extends React.Component {
    ...
    loadProducts = () => {
        ...
        fetch(`http://auz.uz/api/popular?offset=${offset}&lang=${this.props.lang}&limit=${limit}`).then(res => res.json()).then(json => {
...
export default withNavigation(connect(mapStateToProps, { fetchProducts })(HotScreen))